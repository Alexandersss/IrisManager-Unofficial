...
t_lngstr lang_strings[] = 
{
   ...
   // { DRAWTOOLS_SECENABLE, "DRAWTOOLS_SECENABLE"     , "Press To Enable Syscall Security" },
    ...
    { DRAWTOOLS_LANGUAGE_8, "DRAWTOOLS_LANGUAGE_8"     , "Arabic" },
	...
	{ DRAWTOOLS_LANGUAGE_11, "DRAWTOOLS_LANGUAGE_10"     , "Polish"},
    { DRAWTOOLS_LANGUAGE_12, "DRAWTOOLS_LANGUAGE_11"     , "Custom (from file)"},
...
int open_language (int lang, char * filename) 
{
    ...
    if(lang>=11) { // test external filename
        if(!stat(filename, &s))
        ...
        if(lang>=11)
        {
            ...
            switch(lang) {
                ...
                case 6: // por
                    ...
                    break;
                case 7: // ar
                    file_bin = (char *) language_ini_ar_bin;
                    file_size = language_ini_ar_bin_size;
                    break;
                case 8: // chs
