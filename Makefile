...
#---------------------------------------------------------------------------------
# TARGET è il nome dell'output
# BUILD è la directory in cui verranno posizionati i file oggetto e file intermedi
# SOURCES  è una lista di directory che contiene il codice sorgente
# INCLUDES è una lista di directory che contengono i file di intestazione aggiuntivi
#---------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------
# non c'è alcuna reale necessità di modificare niente oltre questo punto se 
# non è necessario aggiungere ulteriore regole per le estensioni di file diversi
#---------------------------------------------------------------------------------
